...
#Power spectrum - compressed Bispectrum models

#single field
#does not recompute B0_terms, this is what we use
@model function PpcB_qso_convolved_IC(dataPB, p, iΓPB, kP, PPₘ, α_kP, B0_terms, BGIC_terms, fP, fB, QₗP, W₀P, start_kP, WricP, WricB, PsnB, R)
    ...
    #compressing B0
    predictionB_compress = R * predictionB

    predictionPB = vcat(vec(predictionP), predictionB_compress)
...
#B terms not recomputed, this is what we use
@model function PpcB_qso_convolved_IC(dataPBN, dataPBS, p, iΓPBN, iΓPBS, kPN, kPS, PPₘN, PPₘS, α_kPN, α_kPS, B0_termsN, B0_termsS, BGIC_termsN, BGIC_termsS, fPN, fPS, fBN, fBS, QₗPN, QₗPS, W₀PN, W₀PS, start_kPN, start_kPS, WricPN, WricPS, WricBN, WricBS, PsnBN, PsnBS, RN, RS)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    ϵ = 0.2
    ...
    #compressing B0
    predictionBN_compress = RN * predictionBN
    predictionBS_compress = RS * predictionBS

    predictionPBN = vcat(vec(predictionPN), predictionBN_compress)
    predictionPBS = vcat(vec(predictionPS), predictionBS_compress)
...
#single field
#does not recompute B0_terms, this is what we use
@model function PpcB_qso_convolved_IC(dataPB, p, iΓPB, kP, PPₘ, α_kP, B0_terms, BGIC_terms, fP, fB, QₗP, W₀P, start_kP, WricP, WricB, PsnB, R, fast::Bool)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    #b₁P ~ Uniform(0.2, 6) 
    #b₁B ~ Uniform(0.1, b₁P)
...
#joint analysis NGC and SGC
#B terms not recomputed, this is what we use
@model function PpcB_qso_convolved_IC(dataPBN, dataPBS, p, iΓPBN, iΓPBS, kPN, kPS, PPₘN, PPₘS, α_kPN, α_kPS, B0_termsN, B0_termsS, BGIC_termsN, BGIC_termsS, fPN, fPS, fBN, fBS, QₗPN, QₗPS, W₀PN, W₀PS, start_kPN, start_kPS, WricPN, WricPS, WricBN, WricBS, PsnBN, PsnBS, RN, RS, fats::Bool)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    ϵ = 0.2
    μbsN = [2.30, 2.28] # [b₁P, b₁B]
...
#compressed (Power spectrum + Bispectrum) models

#single field
#does not recompute B0_terms, this is what we use
@model function cPpB_qso_convolved_IC(dataPB, p, iΓPB, kP, PPₘ, α_kP, B0_terms, BGIC_terms, fP, fB, QₗP, W₀P, start_kP, WricP, WricB, PsnB, R)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    #b₁P ~ Uniform(0.2, 6) 
    #b₁B ~ Uniform(0.1, b₁P)
    ...
    #compressing PB
    predictionPB_compress = R * predictionPB
    
    predictionPB_recast = iΓPB * predictionPB_compress
...
#joint analysis NGC and SGC
#B terms not recomputed, this is what we use
@model function cPpB_qso_convolved_IC(dataPBN, dataPBS, p, iΓPBN, iΓPBS, kPN, kPS, PPₘN, PPₘS, α_kPN, α_kPS, B0_termsN, B0_termsS, BGIC_termsN, BGIC_termsS, fPN, fPS, fBN, fBS, QₗPN, QₗPS, W₀PN, W₀PS, start_kPN, start_kPS, WricPN, WricPS, WricBN, WricBS, PsnBN, PsnBS, RN, RS)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    ϵ = 0.2
    μbsN = [2.30, 2.28] # [b₁P, b₁B]
    ...
    #compressing B0
    predictionPBN_compress = RN * predictionPBN
    predictionPBS_compress = RS * predictionPBS
    
    predictionPBN_recast = iΓPBN * predictionPBN_compress
    predictionPBS_recast = iΓPBS * predictionPBS_compress
...
#single field
#does not recompute B0_terms, this is what we use
@model function cPpB_qso_convolved_IC(dataPB, p, iΓPB, kP, PPₘ, α_kP, B0_terms, BGIC_terms, fP, fB, QₗP, W₀P, start_kP, WricP, WricB, PsnB, R, fast::Bool)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    #b₁P ~ Uniform(0.2, 6) 
    #b₁B ~ Uniform(0.1, b₁P)
...
#joint analysis NGC and SGC
#B terms not recomputed, this is what we use
@model function cPpB_qso_convolved_IC(dataPBN, dataPBS, p, iΓPBN, iΓPBS, kPN, kPS, PPₘN, PPₘS, α_kPN, α_kPS, B0_termsN, B0_termsS, BGIC_termsN, BGIC_termsS, fPN, fPS, fBN, fBS, QₗPN, QₗPS, W₀PN, W₀PS, start_kPN, start_kPS, WricPN, WricPS, WricBN, WricBS, PsnBN, PsnBS, RN, RS, fast::Bool)
    #prior: common to P and b
    fNL ~ Uniform(-500, 500)
    ϵ = 0.2
    μbsN = [2.30, 2.28] # [b₁P, b₁B]
