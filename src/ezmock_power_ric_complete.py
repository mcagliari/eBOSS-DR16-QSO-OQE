...
def main(ns):
    ...
    for box_num in range(ns.start, ns.stop, ns.step):
        ...
        randname = f'ran/EZmock_complete_eBOSS_QSO_{ns.sample}GC.ran.fits.gz'
        ...
        # load the randoms
        randoms = eboss.read_new_ezmock_complete_randoms(box_num, ns.sample, shuffle=False)
        ...
        if ns.p == -1.:
            ...
            eboss.save_ezmock_spectra(result, box_num, ns.sample, eztype='complete', **meta)
...
if __name__ == '__main__':
    ...
    with conf.set_temp('remote_timeout', 120):
      # and go!
